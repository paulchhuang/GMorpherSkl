 ...
 * *************************************************/
#ifndef ENERGYTERM_CVTRIGIDITY_CEDRIC_CERES_H_DEFINED
#define ENERGYTERM_CVTRIGIDITY_CEDRIC_CERES_H_DEFINED

#include <IEnergyTerm_ceres.h>
#include "ClusteredCVTCloud.h"
...
namespace CVTClusteredCloud
{
	...
	struct RigidityConstraintCEDRIC
	{
		...
		template <typename T>
		bool operator()(const T* const para_k, const T* para_l, T* residuals) const {
	...
	class EnergyTerm_cvtRigidity_CEDRIC_ceres : public GMorpher::IEnergyTermCeres
	{
		public :
			EnergyTerm_cvtRigidity_CEDRIC_ceres(const CVTClusteredCloud&  PC);

			virtual ~EnergyTerm_cvtRigidity_CEDRIC_ceres();
