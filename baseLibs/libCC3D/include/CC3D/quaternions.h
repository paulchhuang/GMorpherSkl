 ...
 * *************************************************/
#ifndef CC3D_QUATERNIONS_H_DEFINED
#define CC3D_QUATERNIONS_H_DEFINED
...
template <typename T>
inline void Quat_inverse( const T* q1, T* q)
{// q = inv(q1) = cong(q1)/norm(q1);
	float q_norm2 = q1[0]*q1[0] + q1[1]*q1[1] + q1[2]*q1[2] + q1[3]*q1[3];
